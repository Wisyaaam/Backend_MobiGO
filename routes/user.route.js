...
app.get('/bylogin', authControll.authorize, roleValidate.isAdmin, userController.getByLogin) // GET ALL USER
...
app.put('/edit/:id', authControll.authorize, userController.updateUser) // UPDATE USER
